...
import MealReport from './reports/meal-report.jsx';
    ...
    return (
      <div className="dashboard-container" onClick={this.closeForm}>
        ...
        <div className="dashboard-window">
          <div className="report-tile shadow"><MealReport auth={this.props.getAuth} title="Recent Ingredients:" type="Meal"/></div>
